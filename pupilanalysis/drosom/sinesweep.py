...
Currently supports Pupil Imsoft flash_type's 
'''
...
def _get_stimulus(flash_type, t, fs):
    ...
    flash_type : strings
        Flash_type used in Pupil Imsoft
    t : float
...
def _sham_frequency_response(stimulus_timepoints, stimulus_frequencies, stimulus, response,
    ...
    '''
    #fn = '/home/joni/.pupilanalysis/final_results/sineweep_analysis/wtb_sinusoidal_07_right_sinelogsweep.csv'
    #fn = '/home/joni/.pupilanalysis/final_results/sineweep_analysis/wtb_sinusoidal_07_right_squarewave_cam200Hz.csv'
    #data = np.loadtxt(fn,
